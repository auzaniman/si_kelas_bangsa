        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link
                    ...
                    active
                    @endif"
                    href="{{ route('user_officer.table_member') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link
                    @if (\Request::is('user_officer/kategori_peminatan*'))
                    active
                    @endif"
                    href="{{route('user_officer.kategori_peminatan')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link
                    @if (\Request::is('user_officer/informasi_berita*'))
                    active
                    @endif"
                    href="{{route('user_officer.informasi_berita')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link
                    @if (\Request::is('user_officer/event*'))
                    active
                    @endif"
                    href="{{route('user_officer.event')}}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>settings</title>
                        <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
